...
export const metadata: Metadata = {
  title: 'Best mri-scan Centers in Mumbai | Henotic Diagnostics',
  description: 'Book mri-scan in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'mri-scan';
