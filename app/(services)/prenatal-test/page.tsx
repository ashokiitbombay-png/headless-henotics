...
export const metadata: Metadata = {
  title: 'Best prenatal-test Centers in Mumbai | Henotic Diagnostics',
  description: 'Book prenatal-test in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'prenatal-test';
