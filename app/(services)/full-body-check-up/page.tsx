...
export const metadata: Metadata = {
  title: 'Best full-body-check-up Centers in Mumbai | Henotic Diagnostics',
  description: 'Book full-body-check-up in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'full-body-check-up';
