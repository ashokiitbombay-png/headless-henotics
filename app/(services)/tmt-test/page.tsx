...
export const metadata: Metadata = {
  title: 'Best tmt-test Centers in Mumbai | Henotic Diagnostics',
  description: 'Book tmt-test in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'tmt-test';
