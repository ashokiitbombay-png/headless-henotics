...
export const metadata: Metadata = {
  title: 'Best obstetric-ultrasound Centers in Mumbai | Henotic Diagnostics',
  description: 'Book obstetric-ultrasound in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'obstetric-ultrasound';
