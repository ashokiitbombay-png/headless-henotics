...
export const metadata: Metadata = {
  title: 'Best color-doppler Centers in Mumbai | Henotic Diagnostics',
  description: 'Book color-doppler in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'color-doppler';
