...
export const metadata: Metadata = {
  title: "Best gut microbiome test in Mumbai | Henotic Diagnostics",
  description: "Book gut microbiome test in Mumbai. Advanced Genomics, Best Price, Home Collection available.",
};

export default function ServiceHubPage() {
  const serviceSlug = "gut-microbiome-test";
