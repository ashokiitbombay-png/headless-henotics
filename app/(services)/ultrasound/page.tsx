...
export const metadata: Metadata = {
  title: 'Best ultrasound Centers in Mumbai | Henotic Diagnostics',
  description: 'Book ultrasound in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'ultrasound';
