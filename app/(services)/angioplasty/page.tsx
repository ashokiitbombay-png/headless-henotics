...
export const metadata: Metadata = {
  title: 'Best angioplasty Centers in Mumbai | Henotic Diagnostics',
  description: 'Book angioplasty in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'angioplasty';
