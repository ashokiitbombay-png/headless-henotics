...
export const metadata: Metadata = {
  title: 'Best 2d-echo-test Centers in Mumbai | Henotic Diagnostics',
  description: 'Book 2d-echo-test in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = '2d-echo-test';
