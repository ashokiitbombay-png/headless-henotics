...
export const metadata: Metadata = {
  title: 'Best anomaly-scan Centers in Mumbai | Henotic Diagnostics',
  description: 'Book anomaly-scan in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'anomaly-scan';
