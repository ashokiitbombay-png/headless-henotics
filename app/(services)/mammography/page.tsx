...
export const metadata: Metadata = {
  title: 'Best mammography Centers in Mumbai | Henotic Diagnostics',
  description: 'Book mammography in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'mammography';
