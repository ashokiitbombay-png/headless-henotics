...
export const metadata: Metadata = {
  title: "Best dna testing in Mumbai | Henotic Diagnostics",
  description: "Book dna testing in Mumbai. Advanced Genomics, Best Price, Home Collection available.",
};

export default function ServiceHubPage() {
  const serviceSlug = "dna-testing";
