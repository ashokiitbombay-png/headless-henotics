...
export const metadata: Metadata = {
  title: 'Best nips-test Centers in Mumbai | Henotic Diagnostics',
  description: 'Book nips-test in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'nips-test';
