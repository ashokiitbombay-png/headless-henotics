...
export const metadata: Metadata = {
  title: 'Best follicular-study Centers in Mumbai | Henotic Diagnostics',
  description: 'Book follicular-study in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'follicular-study';
