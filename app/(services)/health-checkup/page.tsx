...
export const metadata: Metadata = {
  title: 'Best health-checkup Centers in Mumbai | Henotic Diagnostics',
  description: 'Book health-checkup in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'health-checkup';
