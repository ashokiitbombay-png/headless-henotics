...
export const metadata: Metadata = {
  title: 'Best blood-tests Centers in Mumbai | Henotic Diagnostics',
  description: 'Book blood-tests in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'blood-tests';
