...
export const metadata: Metadata = {
  title: 'Best stress-test Centers in Mumbai | Henotic Diagnostics',
  description: 'Book stress-test in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'stress-test';
