...
export const metadata: Metadata = {
  title: 'Best holter-monitoring Centers in Mumbai | Henotic Diagnostics',
  description: 'Book holter-monitoring in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'holter-monitoring';
