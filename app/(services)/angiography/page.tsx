...
export const metadata: Metadata = {
  title: 'Best angiography Centers in Mumbai | Henotic Diagnostics',
  description: 'Book angiography in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'angiography';
