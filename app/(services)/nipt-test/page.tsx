...
export const metadata: Metadata = {
  title: 'Best nipt-test Centers in Mumbai | Henotic Diagnostics',
  description: 'Book nipt-test in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'nipt-test';
