...
export const metadata: Metadata = {
  title: 'Best nippt Centers in Mumbai | Henotic Diagnostics',
  description: 'Book nippt in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'nippt';
