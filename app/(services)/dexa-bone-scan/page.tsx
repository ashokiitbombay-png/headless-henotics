...
export const metadata: Metadata = {
  title: 'Best dexa-bone-scan Centers in Mumbai | Henotic Diagnostics',
  description: 'Book dexa-bone-scan in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'dexa-bone-scan';
