...
export const metadata: Metadata = {
  title: 'Best pet-scan Centers in Mumbai | Henotic Diagnostics',
  description: 'Book pet-scan in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'pet-scan';
