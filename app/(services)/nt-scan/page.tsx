...
export const metadata: Metadata = {
  title: 'Best nt-scan Centers in Mumbai | Henotic Diagnostics',
  description: 'Book nt-scan in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'nt-scan';
