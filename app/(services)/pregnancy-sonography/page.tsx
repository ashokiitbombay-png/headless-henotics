...
export const metadata: Metadata = {
  title: 'Best pregnancy-sonography Centers in Mumbai | Henotic Diagnostics',
  description: 'Book pregnancy-sonography in Mumbai. NABL Accredited Labs, Best Price, Home Collection available.',
};

export default function ServicePhysicalPage() {
  const serviceSlug = 'pregnancy-sonography';
