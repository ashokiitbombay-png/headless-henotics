      ...
      <section className="relative text-white py-16 lg:py-24 overflow-hidden" style={{ backgroundImage: "linear-gradient(120deg, #4568dc 0%, #b06ab3 100%)" }}>
        ...
        <div className="container mx-auto px-4 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-white/90 leading-relaxed font-medium">Looking for a <strong>{serviceDisplay} in {cityName}</strong>? Henotic Diagnostics provides the Gold Standard in Bone Densitometry. High precision, low radiation, and instant reporting.</p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 shadow-sm">
                ...
                <ul className="space-y-3 text-slate-700 text-sm">
                  <li className="flex gap-3"><span className="bg-green-100 text-green-700 px-2 py-0.5 rounded font-bold">NORMAL</span> T-score -1.0 or higher. Healthy bone density.</li>
                  <li className="flex gap-3"><span className="bg-yellow-100 text-yellow-700 px-2 py-0.5 rounded font-bold">OSTEOPENIA</span> T-score between -1.0 and -2.5. Low bone mass.</li>
                  <li className="flex gap-3"><span className="bg-red-100 text-red-700 px-2 py-0.5 rounded font-bold">OSTEOPOROSIS</span> T-score -2.5 or lower. High fracture risk.</li>
                  <li className="flex gap-3"><span className="bg-blue-100 text-blue-700 px-2 py-0.5 rounded font-bold">Z-SCORE</span> Comparison to age-matched peers (for younger patients).</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="bg-white py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-4">
            <details className="group bg-slate-50 rounded-xl border border-slate-200 overflow-hidden"><summary className="flex justify-between items-center p-6 font-bold text-slate-800 cursor-pointer hover:bg-slate-100 transition-colors list-none">Is Fasting Required for {serviceDisplay}? <ChevronDown className="group-open:rotate-180 transition-transform text-blue-600" /></summary><div className="px-6 pb-6 pt-0 text-slate-600 leading-relaxed border-t border-slate-200/50 group-open:mt-4">No fasting is needed. You can eat and drink normally. However, you must stop taking Calcium supplements 24 hours before the scan.</div></details>
            <details className="group bg-slate-50 rounded-xl border border-slate-200 overflow-hidden"><summary className="flex justify-between items-center p-6 font-bold text-slate-800 cursor-pointer hover:bg-slate-100 transition-colors list-none">What is the difference between 3-Part and Whole Body? <ChevronDown className="group-open:rotate-180 transition-transform text-blue-600" /></summary><div className="px-6 pb-6 pt-0 text-slate-600 leading-relaxed border-t border-slate-200/50 group-open:mt-4">A 3-Part Scan (Spine + Both Hips) is the medical standard for checking fracture risk. A Whole Body Scan includes all bones and also provides a Body Composition analysis (Fat vs. Muscle mass).</div></details>
            <details className="group bg-slate-50 rounded-xl border border-slate-200 overflow-hidden"><summary className="flex justify-between items-center p-6 font-bold text-slate-800 cursor-pointer hover:bg-slate-100 transition-colors list-none">How long does the report take? <ChevronDown className="group-open:rotate-180 transition-transform text-blue-600" /></summary><div className="px-6 pb-6 pt-0 text-slate-600 leading-relaxed border-t border-slate-200/50 group-open:mt-4">We guarantee reports within 4 hours. You will receive a digital copy via WhatsApp and email, and you can collect the hardcopy film from the center.</div></details>
            <details className="group bg-slate-50 rounded-xl border border-slate-200 overflow-hidden"><summary className="flex justify-between items-center p-6 font-bold text-slate-800 cursor-pointer hover:bg-slate-100 transition-colors list-none">Is the radiation safe? <ChevronDown className="group-open:rotate-180 transition-transform text-blue-600" /></summary><div className="px-6 pb-6 pt-0 text-slate-600 leading-relaxed border-t border-slate-200/50 group-open:mt-4">Yes. DEXA scans use extremely low levels of radiation—about 1/10th of a standard Chest X-ray or less than a cross-country flight. It is safe for routine screening.</div></details>
          </div>
        </div>
      </section>
