...
import { 
  ...
  Home, ChevronRight, MapPin, Sparkles, Building2, Award 
} from "lucide-react";
...
const TEAM_DATA = [
  {
    name: "Dr. Esha Batra",
    qualifications: "MD, DNB, Radiology, UK",
    experience: "14+ years experience",
    current: "Associated Apollo and MGM",
    imageUrl: "https://storage.googleapis.com/wp-media-henoticbucket/2026/01/b01f282f-henotic-diagnostics-experienced-radiology-doctors-team-for-ct-scan-mri-ultrasound-dexa-and-advanced-diagnostic-imaging.webp.webp",
    bgColor: "bg-[#FFF9F5]", secondaryCircle: "bg-gradient-to-br from-[#FFD5CC] to-[#FFEDD5]", primaryCircle: "bg-[#FDF2F0]", accent: "text-[#E67E6B]", btnColor: "bg-[#E67E6B]"
  },
  {
    name: "Dr. Naresh Reddy",
    qualifications: "MD, DNB, Radiology, USA",
    experience: "12+ years experience",
    current: "Apollo Hospitals and MGM",
    imageUrl: "https://storage.googleapis.com/wp-media-henoticbucket/2026/01/3b2e00c2-henotic-diagnostics-leading-radiologists-and-medical-imaging-doctors-team-delivering-precision-diagnostic-healthcare-solutions.webp.webp",
    bgColor: "bg-[#F8F9FF]", secondaryCircle: "bg-gradient-to-br from-[#CCD9FF] to-[#E0E7FF]", primaryCircle: "bg-[#F0F4FF]", accent: "text-[#5C7CFA]", btnColor: "bg-[#5C7CFA]"
  },
  {
    name: "Dr. Vimala Choudhary",
    qualifications: "MD, DNB, Radiology, UK",
    experience: "14+ years experience",
    current: "Apollo and GMG Hospitals",
    imageUrl: "https://storage.googleapis.com/wp-media-henoticbucket/2026/01/ea38942d-henotic-diagnostics-best-diagnostic-center-navi-mumbai-pathology-lab-near-me-blood-test-full-body-checkup-medical-lab-navi-mumbai-health-packages-mri-ct-scan-ultrasound-lab-test-1.webp",
    bgColor: "bg-[#F7FDF9]", secondaryCircle: "bg-gradient-to-br from-[#CCFBF1] to-[#D1FAE5]", primaryCircle: "bg-[#F0FDF4]", accent: "text-[#0D9488]", btnColor: "bg-[#0D9488]"
  }
];
...
const ProfileCard = ({ doctor }: { doctor: any }) => (
  <div className="group bg-white rounded-[3rem] overflow-hidden shadow-[0_30px_70px_-20px_rgba(0,0,0,0.08)] border border-gray-100 transition-all duration-500 hover:shadow-[0_40px_80px_-15px_rgba(0,0,0,0.12)] hover:-translate-y-3 flex flex-col h-full">
    <div className={`relative h-[340px] w-full ${doctor.bgColor} overflow-hidden flex items-center justify-center`}>
      ...
      <div className="relative z-10 w-full h-full pt-10 flex justify-center items-end"><img src={doctor.imageUrl} alt={doctor.name} className="h-[95%] w-auto object-contain transition-transform duration-700 ease-out group-hover:scale-110 group-hover:translate-y-[-5px]" /></div>
        ...
        <div className="container mx-auto px-4 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
               ...
               <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-lg text-white border border-white/10 text-sm font-bold"><CheckCircle2 size={16} /> NABL Lab</div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-slate-600 leading-relaxed">The <strong>Dual-Energy X-ray Absorptiometry (DEXA)</strong> scan utilizes two distinct X-ray energy beams. One beam is absorbed by soft tissue, and the other by bone. By subtracting soft tissue absorption, our advanced Fan-Beam technology calculates <strong>Bone Mineral Density (BMD)</strong> in g/cm² with high precision.</p>
      ...
      <section className="bg-slate-50 py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-4">
            {FAQS.map((f, i) => (<details key={i} className="group bg-white rounded-xl border border-slate-200 overflow-hidden"><summary className="flex justify-between items-center p-6 font-bold text-slate-800 cursor-pointer hover:bg-slate-50 transition-colors list-none">{f.q} <ChevronDown className="group-open:rotate-180 transition-transform text-blue-600" /></summary><div className="px-6 pb-6 pt-0 text-slate-600 leading-relaxed border-t border-slate-100 group-open:mt-4">{f.a}</div></details>))}
          </div>
        </div>
      </section>
