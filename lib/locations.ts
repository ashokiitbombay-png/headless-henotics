export const TARGET_LOCATIONS = [
  // South Mumbai
  "Colaba", "Cuffe Parade", "Fort", "Churchgate", "Marine Lines", "Nariman Point", 
  "Worli", "Parel", "Lower Parel", "Mahalaxmi", "Byculla", "Dadar",
  ...
  // Navi Mumbai
  "Vashi", "Sanpada", "Juinagar", "Nerul", "Seawoods", "CBD Belapur", "Kharghar", 
  "Kamothe", "Kalamboli", "Panvel", "New Panvel", "Taloja", "Ghansoli", 
  "Kopar Khairane", "Airoli", "Turbhe"
];
