...
const TEAM_DATA = [
  ...
  },
  {
    ...
    qualifications: "MD, DNB, Orthopaedic Surgeon, USA",
  ...
  },
  {
    ...
    qualifications: "MD, DNB, Radiology, Fetal Med, UK",
    experience: "14+ years experience",
    ...
    <div className={`relative h-[340px] w-full ${doctor.bgColor} overflow-hidden flex items-center justify-center`}>
      ...
      <div className="relative z-10 w-full h-full pt-10 flex justify-center items-end">
        <img 
          src={doctor.imageUrl} 
          alt={doctor.name} 
          className="h-[95%] w-auto object-contain transition-transform duration-700 ease-out group-hover:scale-110 group-hover:translate-y-[-5px]" 
    ...
    <section className="bg-white py-24 px-8 border-t border-slate-100">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-8">
           <div className="max-w-2xl"><div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 border border-blue-200 text-blue-600 text-[10px] font-black uppercase tracking-[0.3em] mb-6"><Sparkles size={14} className="text-amber-400" /> Henotic Diagnostics Experts</div><h2 className="text-5xl md:text-7xl font-black text-gray-950 tracking-tighter leading-[0.9]">Precision Imaging. <br /> <span className="text-gray-400">Trusted Expertise.</span></h2></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {TEAM_DATA.map((doctor, index) => (<ProfileCard key={index} doctor={doctor} />))}
        </div>
